        ...
        <footer className="bg-gray-900">
            <div className="max-w-screen-xl mx-auto px-4 w-full py-10 md:py-16">
                <div className="grid md:grid-cols-3 gap-7">
                    ...
                    <div>
                        <h4 className="mb-8 text-xl font-semiold text-white">Newsletter</h4>
                        <p className="text-gray-400">lorem ipsum dolor sit amet</p>
            ...
            py-8 text-center text-base text-gray-500">
                &copy; Copyright 2025 | aefryyu | All Rights Reserved
            </div>
        </footer>
    );
};
