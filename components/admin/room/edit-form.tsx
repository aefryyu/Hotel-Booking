            ...
            <div className="grid md:grid-cols-12 gap-5">
                ...
                <div className="col-span-4 bg-white p-4">
                    <label
                        ...
                        border-gray-3 border-dashed rounded-md cursor-pinter bg-gray-50 relative">
                        <div className="flex flex-col items-ceter justify-center text-gray-500 pt-5 pb-6 z-10">
                            ...
                            {image ? (
                                <button
                                    ...
                                    className="flex items-center justify-center bg-transparent size-6 rounded-sm absolute right-1 top-1 text-white hover:bg-red-100"
                                >
